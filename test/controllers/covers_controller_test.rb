...
class CoversControllerTest < ActionController::TestCase
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post :create, cover: { author: @cover.author, description: @cover.description, title: @cover.title, ytlink: @cover.ytlink }
    end
  ...
  test "should update cover" do
    patch :update, id: @cover, cover: { author: @cover.author, description: @cover.description, title: @cover.title, ytlink: @cover.ytlink }
    assert_redirected_to cover_path(assigns(:cover))
  end
